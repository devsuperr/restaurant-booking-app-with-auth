...
export const SEVEN_DAY_PLAN: DayTask[] = [
  {
    day: 1,
    title: 'Basics Samjho – Foundation Day',
    description: 'Aaj hum sikhenge ki video editing kya hoti hai aur basic tools kaise use kare.',
    videoTitle: 'CapCut se shuru karo – 15 min crash course',
    assignment: 'Apne phone ka koi ek video edit karo aur WhatsApp pe share karo',
    earning: 0,
    completed: true,
    xp: 100,
  },
  {
    day: 2,
    title: 'Pehla Kaam – First Task Day',
    description: 'Aaj tumhara pehla real assignment hai. Ek simple 30-second reel banao.',
    videoTitle: 'Transitions aur music kaise add kare',
    assignment: 'Instagram reel banao kisi bhi topic pe – 30 seconds',
    earning: 150,
    completed: true,
    xp: 200,
  },
  {
    day: 3,
    title: 'Speed Up – Efficiency Training',
    description: 'Aaj hum shortcut keys aur fast editing techniques seekhenge.',
    videoTitle: 'Pro editor ki tarah kaam karo – shortcuts guide',
    assignment: 'Ek product review video banao – 1 minute',
    earning: 250,
    completed: true,
    xp: 300,
  },
  {
    day: 4,
    title: 'Client Work Simulation',
    description: 'Real client ki tarah ek brief diya gaya hai. Uss pe kaam karo.',
    videoTitle: 'Client brief kaise samjhe – real example',
    assignment: 'Diye gaye brief ke according ek video complete karo',
    earning: 400,
    completed: false,
    xp: 400,
  },
  {
    day: 5,
    title: 'Portfolio Banao',
    description: 'Aaj tumhara portfolio banane ka din hai. Yahi tumhe kaam dilaega.',
    videoTitle: 'Portfolio kaise banaye jisse client hire kare',
    assignment: 'Apne 3 best videos ka portfolio pack banao',
    earning: 0,
    completed: false,
    xp: 350,
  },
  {
    day: 6,
    title: 'Pehla Gig Apply Karo',
    description: 'Aaj pehli baar real platform pe apply karenge. Darr mat!',
    videoTitle: 'Fiverr/Internshala profile kaise setup kare',
    assignment: 'Ek platform pe profile banao aur pehla proposal bhejo',
    earning: 500,
    completed: false,
    xp: 500,
  },
  {
    ...
    description: 'Badhai ho! Tum ab ek earning-ready video editor ho.',
    videoTitle: 'Scale karo – 10k se 50k per month ka roadmap',
    assignment: 'Apna success story share karo community mein',
    earning: 750,
    completed: false,
    xp: 600,
  },
...
export const GIG_TASKS: GigTask[] = [
  {
    id: 'g1',
    title: 'Instagram Reels ke liye 3 short videos edit karo',
    category: 'Video Editing',
    earning: 800,
    duration: '2 ghante',
    difficulty: 'Easy',
    emoji: '🎬',
    postedBy: 'Priya Fashion Store',
  },
  {
    id: 'g2',
    title: 'Restaurant menu ka Canva design banao',
    category: 'Design',
    earning: 500,
    duration: '1 ghanta',
    difficulty: 'Easy',
    emoji: '🎨',
    postedBy: 'Raju Dhaba, Jaipur',
  },
  {
    id: 'g3',
    title: 'Excel mein 500 entries fill karo',
    category: 'Data Entry',
    earning: 350,
    duration: '3 ghante',
    difficulty: 'Easy',
  ...
  {
    id: 'g4',
    title: 'WhatsApp broadcast ke liye 10 messages likhni hain',
    category: 'Writing',
    earning: 300,
    duration: '1 ghanta',
    difficulty: 'Easy',
    emoji: '✍️',
    postedBy: 'Local Kirana Chain',
  },
  {
    id: 'g5',
    title: 'Facebook page ke liye 7 din ke posts banao',
    category: 'Social Media',
    earning: 700,
    duration: '2 din',
    difficulty: 'Medium',
    emoji: '📱',
    postedBy: 'Sneha Boutique',
  },
  {
    id: 'g6',
    title: 'Ghar ki wiring check karni hai (on-site)',
    category: 'Electrical',
    earning: 1200,
    duration: '4 ghante',
    difficulty: 'Medium',
    emoji: '⚡',
    postedBy: 'Sharma Niwas, Lucknow',
  },
];
